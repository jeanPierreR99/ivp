        ...
        <footer className="bg-gray-100  mt-10">
            <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-10 grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-700">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <h1 className="hover:underline">Inicio</h1>
                    <h1 className="hover:underline">Requisitos</h1>
                    <h1 className="hover:underline">Convocatorias</h1>
                    <h1 className="hover:underline">Postulación</h1>
                    <h1 className="hover:underline">Contacto</h1>
                </div>
